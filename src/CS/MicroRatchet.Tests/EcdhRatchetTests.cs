...
namespace MicroRatchet.Tests
{
    public class EcdhRatchetTests
    {
        ...
        private IKeyAgreementFactory kaf = new DefaultServices(KeyGeneration.GeneratePrivateKey()).KeyAgreementFactory;
        ...
        public void ServerInitializeTest()
        {
            ...
            var ecdhstep = EcdhRatchetStep.InitializeServer(kdf,
        ...
        public void ClientInitializeTest()
        {
            ...
            var ecdhsteps = EcdhRatchetStep.InitializeClient(kdf,
        ...
        public void InitialChainSymmetryTest1()
        {
            ...
            var secdhstep = EcdhRatchetStep.InitializeServer(kdf,
                skey1, rk, cpub1, skey2, rhk, shk);
            var cecdhsteps = EcdhRatchetStep.InitializeClient(kdf,
        ...
        public void InitialChainRatchetTest()
        {
            ...
            byte[] cpub1 = ckey1.GetPublicKey();
            byte[] cpub2 = ckey2.GetPublicKey();
            var secdhstep1 = EcdhRatchetStep.InitializeServer(kdf,
                skey1, rk, cpub1, skey2, rhk, shk);
            var cecdhsteps = EcdhRatchetStep.InitializeClient(kdf,
                rk, spub1, spub2, ckey1, shk, rhk, ckey2);

            // client sends new ECDH to server
            var secdhstep2 = secdhstep1.Ratchet(kaf, kdf,
                cpub2, skey3);
        ...
        public void SecondChainRatchetTest()
        {
            ...
            var cecdhstep3 = cecdhsteps[1].Ratchet(kaf, kdf,
                spub3, ckey3);
